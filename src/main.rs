...
mod prelude {
    ...
    pub const CONSOLE_WIDTH: i32 = SCREEN_WIDTH * 2;
    pub const CONSOLE_HEIGHT: i32 = SCREEN_HEIGHT * 2;
...
impl State {
    fn new() -> Self {
        ...
        // NOTE Dummies that will be replaced
        let ecs = World::default();
        let resources = Resources::default();

        let mut state = Self { ecs, resources, input_systems, player_systems, monster_systems, };
    ...
    fn reset_game_state(&mut self) {
        ...
        // Replacing these with new ones seems to be the best way to reset them
    ...
    fn victory(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(4, WHITE, BLACK, "You don the Amulet of Yala and feel its power course through your veins.");
        ctx.print_color_centered(5, WHITE, BLACK, "Your town is saved and you may return to your normal life.");
...
impl GameState for State {
    fn tick(&mut self, ctx: &mut BTerm) {
        ...
        ctx.set_active_console(0); // required for mouse_pos
...
fn main() -> BError {
    let context = BTermBuilder::new()
        ...
        .with_simple_console_no_bg(CONSOLE_WIDTH, CONSOLE_HEIGHT, "terminal8x8.png")
        .build()?;
